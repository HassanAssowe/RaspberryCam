...
public class GStreamerSurfaceView extends SurfaceView {
    ...
    //sets screen width & height relative to device resolution.
    DisplayMetrics displayMetrics = getResources().getDisplayMetrics();
    public int media_width = displayMetrics.heightPixels;
    public int media_height = displayMetrics.widthPixels;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        height = Math.max(getSuggestedMinimumWidth(), displayMetrics.widthPixels);
